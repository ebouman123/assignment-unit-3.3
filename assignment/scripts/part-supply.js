...
let partsNeeded = 40
console.log(`We need this many parts: `, partsNeeded);
...
console.log(`Removed the last item from supplyChanges:`, removedItem);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
supplyChanges.push(25);
console.log(`Added "25" to the end of supplyChanges`, supplyChanges);
